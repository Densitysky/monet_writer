...
class _CalendarPageState extends State<CalendarPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final useCard = isNeumorphic || isGolden;
    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          : Column(
        children: [
          _buildStreakHeader(theme, useCard),
          Expanded(
            child: ListView(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              children: [
                _buildHeatmapCalendar(theme, useCard),
                const SizedBox(height: 24),
                _buildDayDetail(theme, useCard),
  ...
  Widget _buildStreakHeader(ThemeData theme, bool useCard) {
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.local_fire_department, color: theme.colorScheme.primary, size: 32),
          ),
    ...
    if (useCard) {
      return Padding(
        ...
        child: AppCard(padding: EdgeInsets.zero, child: header),
      );
    }
    return header;
  }

  Widget _buildHeatmapCalendar(ThemeData theme, bool useCard) {
  ...
  Widget _buildDayDetail(ThemeData theme, bool useCard) {
      ...
      return Column(
        ...
        children: [
          Padding(
            ...
            child: Text('每日详情', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
          ),
          AppCard(padding: EdgeInsets.zero, child: detailContent),
        ],
      );
    }
